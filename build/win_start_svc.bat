...
set UPDATE_TICK=-SERVICE_UPDATE_TICK=1000
...
REM start svc_launch.exe -SERVICE_TYPE=1 -SERVICE_ID=3 %EXTEND_PARAM%
REM start svc_launch.exe -SERVICE_TYPE=1 -SERVICE_ID=4 %EXTEND_PARAM%
REM start svc_launch.exe -SERVICE_TYPE=1 -SERVICE_ID=5 %EXTEND_PARAM%
REM start svc_launch.exe -SERVICE_TYPE=1 -SERVICE_ID=6 %EXTEND_PARAM%
